...
class CastTextIndex(DBIndex):
    ...
    def from_str(cls, s: str) -> Union[SingleIndex, 'CastTextIndex']:
        ...
        E.g:
            ...
            column_name::text or (column_name::text) -> CastTextIndex
        """
        s = strip_off_parenthesis(s)
        if s.endswith('::text'):
            s = strip_off_parenthesis(s.split('::')[0])
            return cls(s)
...
class SubstrIndex(DBIndex):
    ...
    def from_str(cls, s: str) -> Union['SingleIndex', 'CastTextIndex', 'SubstrIndex']:
        ...
        E.g:
            ...
            substr(column_name::text, 1, 2) -> SubstrIndex
        """
        s = strip_off_parenthesis(s)
...
class MultipleIndexes(DBIndex):
    ...
    def from_str(cls, s: str) -> 'MultipleIndexes':
        ...
        E.g:
            ...
            (col1, substr(col2::text, 1, 5)
            (col1, col2, (col3::text), substr(col4, 1, 5), substr(col5::text, 2, 6))
        """
...
class ColumnInfo:
    ...
    def is_text(self):
        return RawDataTypeDB.is_text_data_type(self.raw_data_type)
