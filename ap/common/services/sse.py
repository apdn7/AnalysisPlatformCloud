...
from ap.common.constants import LISTEN_BACKGROUND_TIMEOUT, AnnounceEvent, ListenNotifyType
...
class MessageAnnouncer:
    ...
    def announce(self, data, event, job_id: str | int = None, is_main: bool = False):
        """
