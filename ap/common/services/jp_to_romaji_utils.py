...
# TODO: check `convert_irregular_chars` parameters, this was newly added
def to_romaji(input_str, remote_underline=None, convert_irregular_chars=True):
    if pd.isnull(input_str) or not input_str:
        return input_str
