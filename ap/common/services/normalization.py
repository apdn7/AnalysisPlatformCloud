...
@log_execution_time()
def normalize_df_multiple_columns(df: DataFrame, columns: list[str]):
    for col in columns:
...
def dict_normalize(dict_data: dict):
    for key, value in dict_data.items():
        dict_data[key] = normalize_str(value, convert_irregular_chars=False)
