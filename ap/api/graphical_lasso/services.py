...
from ap.api.sankey_plot.sankey_glasso.grplasso import GroupSankeyDataProcessor, labelencode_by_stat
...
def _gen_proc_colorcodes(procnames):
    ...
    colorcodes = GroupSankeyDataProcessor.get_n_hex_col(num_grps)
