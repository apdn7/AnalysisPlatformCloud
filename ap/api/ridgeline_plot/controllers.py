...
from ap.api.ridgeline_plot.services import (
    ...
    show_trace_data_by_categorical_var,
    show_trace_data_by_cyclic,
    show_trace_data_by_term,
)
...
def trace_data():
    ...
    for single_dic_param in dic_params:
        ...
        if compare_type == RL_CATEGORY:
            rlp_dat, _ = show_trace_data_by_categorical_var(
                root_graph_param,
                single_dic_param,
            ...
            rlp_dat, _ = show_trace_data_by_cyclic(
                root_graph_param,
                single_dic_param,
                max_graph_config[MaxGraphNumber.RLP_MAX_GRAPH.name],
                __FORCE_OFFLINE_MODE__=False,
            ...
            rlp_dat, _ = show_trace_data_by_term(
                root_graph_param,
                single_dic_param,
                max_graph_config[MaxGraphNumber.RLP_MAX_GRAPH.name],
                __FORCE_OFFLINE_MODE__=False,
