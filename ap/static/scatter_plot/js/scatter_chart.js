...
const genScatterLayout = (chartOptions) => {
    ...
    const isXUserFmt = Boolean(chartOptions.xUserFmt);
    const isYUserFmt = Boolean(chartOptions.yUserFmt);
    const xFmt = isXUserFmt ? chartOptions.xUserFmt : chartOptions.xFmt;
    const yFmt = isYUserFmt ? chartOptions.yUserFmt : chartOptions.yFmt;
