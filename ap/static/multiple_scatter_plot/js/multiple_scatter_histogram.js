const genHistogramTrace = (plotData, scaleOption) => {
    ...
    const is_user_fmt = Boolean(plotData.end_col_format);
    const fmt = is_user_fmt ? plotData.end_col_format : kdeData.label_fmt;
    let customBinSize = 1;
...
const genHistogramLayout = (
    ...
    const styleLayout = {
        ...
        xaxis: {
            ...
            tickformat: fmt.includes('e') ? '.1e' : is_user_fmt ? fmt : '',
        },
        yaxis: {
            showticklabels: !isLargeOfSensors,
            showgrid: true,
