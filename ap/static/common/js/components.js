...
const updateI18nCommon = async () => {
    i18nCommon = {
        ...
        newRegister: $('#i18nNewRegister').text(),
        add: $('#i18nAdd').text(),
        copy: $('#i18nCopy').text(),
        rollback: $('#i18nRollback').text(),
        master: $('#i18nMaster').text(),
        linkedItem: $('#i18nLinkedItem').text(),
        masterEdit: $('#i18nMasterEdit').text(),
        linkedItemEdit: $('#i18nLinkedItemEdit').text(),
        undecided: $('#i18nUndecided').text(),
        registerData: $('#i18nRegisterData').text(),
        referenceData: $('#i18nReferenceData').text(),
        chooseLanguage: $('#i18nChooselanguage').text(),
        columnName: $('#i18nColumnName').text(),
        shownName: $('#i18nShownName').text(),
        englishName: $('#i18nColumnEnglishName').text(),
        japaneseName: $('#i18nColumnJapaneseName').text(),
        localName: $('#i18nColumnLocalName').text(),
        asLinkIDHover: $('#i18nAsLinkIDHover').text(),
        asLinkID: $('#i18nAsLinkID').text(),
        orderSetExplain: $('#i18nOrderSetExplain').text(),
        orderSet: $('#i18nOrderSet').text(),
        asKeyOptionHover: $('#i18nAsKeyOptionHover').text(),
        asKeyOption: $('#i18nAsKeyOption').text(),
        sampleData: $('#i18nSampleData').text(),
        columnAttribute: $('#i18nColumnAttribute').text(),
        orderAttributeHover: $('#i18nOrderAttributeHover').text(),
        validateSerialAttribute: $('#i18nValidateSerialAttribute').text(),

        factory_factid: $('#i18n-factory-factid').text(),
        factory_name_sys: $('#i18n-factory-name-sys').text(),
        factory_name_jp: $('#i18n-factory-name-jp').text(),
        factory_name_en: $('#i18n-factory-name-en').text(),
        factory_name_local: $('#i18n-factory-name-local').text(),
        factory_abbr_jp: $('#i18n-factory-abbr-jp').text(),
        factory_abbr_en: $('#i18n-factory-abbr-en').text(),
        factory_abbr_local: $('#i18n-factory-abbr-local').text(),
        location: $('#i18n-location').text(),
        location_name_jp: $('#i18n-location-name-jp').text(),
        location_name_en: $('#i18n-location-name-en').text(),
        location_name_local: $('#i18n-location-name-local').text(),
        location_abbr: $('#i18n-location-abbr').text(),
        plant_factid: $('#i18n-plant-factid').text(),
        Plant_name_sys: $('#i18n-Plant-name-sys').text(),
        plant_name_jp: $('#i18n-plant-name-jp').text(),
        plant_name_en: $('#i18n-plant-name-en').text(),
        plant_name_local: $('#i18n-plant-name-local').text(),
        plant_abbr_jp: $('#i18n-plant-abbr-jp').text(),
        plant_abbr_en: $('#i18n-plant-abbr-en').text(),
        plant_abbr_local: $('#i18n-plant-abbr-local').text(),
        plant_no: $('#i18n-plant-no').text(),
        prod_family_factid: $('#i18n-prod-family-factid').text(),
        prod_family_name_sys: $('#i18n-prod-family-name-sys').text(),
        prod_family_name_jp: $('#i18n-prod-family-name-jp').text(),
        prod_family_name_en: $('#i18n-prod-family-name-en').text(),
        prod_family_name_local: $('#i18n-prod-family-name-local').text(),
        prod_family_abbr_jp: $('#i18n-prod-family-abbr-jp').text(),
        prod_family_abbr_en: $('#i18n-prod-family-abbr-en').text(),
        prod_family_abbr_local: $('#i18n-prod-family-abbr-local').text(),
        line_factid: $('#i18n-line-factid').text(),
        line_name_sys: $('#i18n-line-name-sys').text(),
        line_name_jp: $('#i18n-line-name-jp').text(),
        line_name_en: $('#i18n-line-name-en').text(),
        line_name_local: $('#i18n-line-name-local').text(),
        line_abbr_jp: $('#i18n-line-abbr-jp').text(),
        line_abbr_en: $('#i18n-line-abbr-en').text(),
        line_abbr_local: $('#i18n-line-abbr-local').text(),
        line_no: $('#i18n-line-no').text(),
        outsourcing_flag: $('#i18n-outsourcing-flag').text(),
        supplier: $('#i18n-supplier').text(),
        line_sign: $('#i18n-line-sign').text(),
        outsource: $('#i18n-outsource').text(),
        dept_factid: $('#i18n-dept-factid').text(),
        dept_name_sys: $('#i18n-dept-name-sys').text(),
        dept_name_jp: $('#i18n-dept-name-jp').text(),
        dept_name_en: $('#i18n-dept-name-en').text(),
        dept_name_local: $('#i18n-dept-name-local').text(),
        dept_abbr_jp: $('#i18n-dept-abbr-jp').text(),
        dept_abbr_en: $('#i18n-dept-abbr-en').text(),
        dept_abbr_local: $('#i18n-dept-abbr-local').text(),
        sect_factid: $('#i18n-sect-factid').text(),
        sect_name_sys: $('#i18n-sect-name-sys').text(),
        sect_name_jp: $('#i18n-sect-name-jp').text(),
        sect_name_en: $('#i18n-sect-name-en').text(),
        sect_name_local: $('#i18n-sect-name-local').text(),
        sect_abbr_jp: $('#i18n-sect-abbr-jp').text(),
        sect_abbr_en: $('#i18n-sect-abbr-en').text(),
        sect_abbr_local: $('#i18n-sect-abbr-local').text(),
        equip_factid: $('#i18n-equip-factid').text(),
        equip: $('#i18n-equip').text(),
        equip_product_no: $('#i18n-equip-product-no').text(),
        equip_product_date: $('#i18n-equip-product-date').text(),
        equip_name_sys: $('#i18n-equip-name-sys').text(),
        equip_name_full: $('#i18n-equip-name-full').text(),
        equip_name_jp: $('#i18n-equip-name-jp').text(),
        equip_name_en: $('#i18n-equip-name-en').text(),
        equip_name_local: $('#i18n-equip-name-local').text(),
        equip_no: $('#i18n-equip-no').text(),
        equip_abbr_jp: $('#i18n-equip-abbr-jp').text(),
        equip_abbr_en: $('#i18n-equip-abbr-en').text(),
        equip_abbr_local: $('#i18n-equip-abbr-local').text(),
        st_no: $('#i18n-st-no').text(),
        st_sign: $('#i18n-st-sign').text(),
        prod_factid: $('#i18n-prod-factid').text(),
        prod_name_sys: $('#i18n-prod-name-sys').text(),
        prod_name_jp: $('#i18n-prod-name-jp').text(),
        prod_name_en: $('#i18n-prod-name-en').text(),
        prod_name_local: $('#i18n-prod-name-local').text(),
        prod_abbr_jp: $('#i18n-prod-abbr-jp').text(),
        prod_abbr_en: $('#i18n-prod-abbr-en').text(),
        prod_abbr_local: $('#i18n-prod-abbr-local').text(),
        part_type_factid: $('#i18n-part-type-factid').text(),
        part_name_sys: $('#i18n-part-name-sys').text(),
        part_name_jp: $('#i18n-part-name-jp').text(),
        part_name_en: $('#i18n-part-name-en').text(),
        part_name_local: $('#i18n-part-name-local').text(),
        assy_flag: $('#i18n-assy-flag').text(),
        part_factid: $('#i18n-part-factid').text(),
        part_no: $('#i18n-part-no').text(),
        part_use: $('#i18n-part-use').text(),
        process_factid: $('#i18n-process-factid').text(),
        process_name_jp: $('#i18n-process-name-jp').text(),
        process_name_en: $('#i18n-process-name-en').text(),
        process_name_local: $('#i18n-process-name-local').text(),
        process_abbr_jp: $('#i18n-process-abbr-jp').text(),
        process_abbr_en: $('#i18n-process-abbr-en').text(),
        process_abbr_local: $('#i18n-process-abbr-local').text(),
        data_factid: $('#i18n-data-factid').text(),
        data_name: $('#i18n-data-name').text(),
        data_type: $('#i18n-data-type').text(),
        unit: $('#i18n-unit').text(),
        equation_flag: $('#i18n-equation-flag').text(),
        equation: $('#i18n-equation').text(),
        source: $('#i18n-Source').text(),
        sub_source: $('#i18n-Sub-source').text(),
        equip_st: $('#i18n-equip-st').text(),
        equip_sign: $('#i18n-equip-sign').text(),
        data_name_jp: $('#i18n-data-name-jp').text(),
        data_name_en: $('#i18n-data-name-en').text(),
        data_name_local: $('#i18n-data-name-local').text(),
        data_abbr_jp: $('#i18n-data-abbr-jp').text(),
        data_abbr_en: $('#i18n-data-abbr-en').text(),
        data_abbr_local: $('#i18n-data-abbr-local').text(),
        config_equation_id: $('#i18n-config-equation-id').text(),
        quantity_jp: $('#i18n-quantity-jp').text(),
        quantity_en: $('#i18n-quantity-en').text(),
        type: $('#i18n-type').text(),
        dataType: $('#i18nDataType').text(),
        format: $('#i18nFormat').text(),
        base: $('#i18n-base').text(),
        conversion: $('#i18n-conversion').text(),
        denominator: $('#i18n-denominator').text(),
        offset: $('#i18n-offset').text(),
        t_factory_id: $('#i18n-t-factory-id').text(),
        t_factory_name: $('#i18n-t-factory-name').text(),
        t_plant_id: $('#i18n-t-plant-id').text(),
        t_plant_name: $('#i18n-t-plant-name').text(),
        t_dept_id: $('#i18n-t-dept-id').text(),
        t_dept_name: $('#i18n-t-dept-name').text(),
        t_line_id: $('#i18n-t-line-id').text(),
        t_line_name: $('#i18n-t-line-name').text(),
        t_equip_id: $('#i18n-t-equip-id').text(),
        t_equip_name: $('#i18n-t-equip-name').text(),
        t_part_no: $('#i18n-t-part-no').text(),
        t_process_id: $('#i18n-t-process-id').text(),
        t_process_name: $('#i18n-t-process-name').text(),
        t_data_id: $('#i18n-t-data-id').text(),
        t_data_name: $('#i18n-t-data-name').text(),
        t_unit: $('#i18n-t-unit').text(),
        state: $('#i18n-state').text(),
        data_name_all: $('#i18n-data-name-all').text(),
        dept_name_all: $('#i18n-dept-name-all').text(),
        equip_name_all: $('#i18n-equip-name-all').text(),
        factory_name_all: $('#i18n-factory-name-all').text(),
        line_name_all: $('#i18n-line-name-all').text(),
        part_name_all: $('#i18n-part-name-all').text(),
        plant_name_all: $('#i18n-plant-name-all').text(),
        process_name_all: $('#i18n-process-name-all').text(),
        prod_name_all: $('#i18n-prod-name-all').text(),
        prod_family_name_all: $('#i18n-prod-family-name-all').text(),
        sect_name_all: $('#i18n-sect-name-all').text(),
        data_source_name: $('#i18nDataSourceName').text(),
        data_table_name: $('#i18nDataTableName').text(),
        ...
        masterCandidate: $('#i18nMasterCandidate').text(),
    };
};
...
const isMasterDataType = (itemColumnType) => {
    return (
        itemColumnType < masterDataGroup.GENERATED &&
        itemColumnType !== masterDataGroup.DATA_SERIAL &&
        itemColumnType !== masterDataGroup.DATA_TIME &&
        itemColumnType !== masterDataGroup.DATA_SOURCE_NAME &&
        itemColumnType !== masterDataGroup.MAIN_DATE &&
        itemColumnType !== masterDataGroup.MAIN_TIME
    );
};
...
const addGroupListCheckboxWithSearch = (
            ...
            for (let i = 2; i < originalTotalCol.length; i++) {
                if (originalTotalCol[i]) {
                    if (i === indexDic.dataType) {
                        ...
                        html += `<div class="col data-type fit-item type-item px-1 search-col" title="${title}" data-origin-order-no="${orginOrderNo}">
    ...
    for (let i = 0; i < itemIds.length; i++) {
        ...
        const masterInfo = (props.masterInfos ?? {})[i];
        let itemName = null;
        let threshold = null;
        if (props.itemNames) {
        ...
        if (props.itemDataTypes) {
            ...
            if (props.itemRawDataTypes[i] === DataTypes.CATEGORY.bs_value) {
                colDataType = DataTypes.CATEGORY.name;
            }

            if (isMasterDataType(props.itemColumnTypes[i])) {
                colDataType = DataTypes.MASTER.name;
            }
        ...
        let masterNameAttr = '';
        if (masterInfo != null) {
            for (const [key, value] of Object.entries(masterInfo)) {
                dataMasterInfo += ` data-${key}="${value}"`;
            }
            masterNameAttr =
                props.masterName == null || props.masterName === ''
                    ? ''
        ...
        const option = `
            ${inputEl}
           <label class="custom-control-label${hideClass}" for="" title="${itemVal}" ${dataMasterInfo} ${masterNameAttr} name="lblFilter">${itemVal}</label>`;
    ...
    // event hover label to show master detail info
    $('label[name="lblFilter"]')
        .off()
        .on('mouseenter', (e) => {
            const $el = $(e.currentTarget);
            const masterInfo = $el.data();
            if (masterInfo == null || Object.keys(masterInfo).length === 0)
                return;

            const masterName = $el.attr('masterName');
            let i18nMasterInfo = {};
            const [
                reservedNull,
            ...
            for (const key in masterInfo) {
                ...
                if (key === 'id' || key.includes('_id')) {
                    ...
                    consoleLogDebug(`[Hover][Filter] ${key}: ${value}`);
                    continue;
                }

                const is_reserved_null =
                    (reservedNull &&
                        targetReservedNullColumnNames.includes(key)) ||
                    (parentReservedNull &&
            ...
            let hoverContent = '<tr>';
            for (const key in i18nMasterInfo) {
                const [value, is_reserved_null] = i18nMasterInfo[key];
                hoverContent += genTRItems(
                    key,
                    value,
                    undefined,
                    is_reserved_null,
            ...
            initHoverInfoHandler(() => {
                ...
                const $dpInfor = $(`#${dpInfoCons.domID}`);
                $dpInfor.find('tbody').html(hoverContent);
                $dpInfor
                    .css('top', offset.top - 66 + dpInfoCons.marginTop)
...
const onchangeJudge = (e) => {
    ...
    if (isChecked) {
        ...
        if (
            ...
            dataType === DataTypes.CATEGORY.name ||
            dataType === DataTypes.DATE.name ||
        ...
        if (!['catExpBox', 'colorVar'].includes($(selected).attr('name'))) {
            $.each($(selected).find('option'), (key, option) => {
                ...
                if (
                    ...
                    Number(optionVal) !== masterDataGroup.HORIZONTAL_DATA
                ) {
                    // skip disable for Horizontal Data option -> allow select multi-times
...
const getFilterByTypes = (process, filterType) => {
    ...
    const filterIDs = [];
    const filterVals = [];
    const filterMasterInfos = [];
    if (filterType !== filterTypes.OTHER) {
        procFilters.forEach((filter) => {
            let filterDetails = filter.filter_details || [];
            filterDetails = filterDetails.sort((a, b) =>
                a.name.localeCompare(b.name),
            );
            filterDetails.forEach((filterItem) => {
                filterIDs.push(filterItem.id);
                filterVals.push(filterItem.name);
                if (filter.master_info != null) {
                    filterMasterInfos.push(
                        filter.master_info[filterItem.filter_condition],
                    );
                }
            });
        });
        return [filterIDs, filterVals, filterMasterInfos];
    }
    ...
    if (selectedLines.length === 0) {
        ...
        if (!isEmpty(procInfo)) {
            ...
            const machineFilter = procInfo.getOneFilterByType(
                filterTypes.EQUIP_ID,
            );
            if (machineFilter) {
                // const filterDetails = machineFilter.filter_details || [];
                let filterDetails = machineFilter.filter_details || [];
                filterDetails = filterDetails.sort((a, b) =>
                    a.name.localeCompare(b.name),
                );
                if (
                    ...
                    filterDetails.forEach((filterDetail) => {
                        ...
                        if (machineFilter.master_info != null) {
                            machineMasterInfos.push(
                                machineFilter.master_info[
                                    filterDetail.filter_condition
                                ],
                            );
                        }
                    });
            ...
            if (machineIds) {
                ...
                addGroupListCheckboxWithSearch(
                    ...
                    machineVals,
                    {
                        ...
                        noFilter: true,
                        thresholdBoxes,
                        masterName: masterNameColumnDict.__EQUIP__,
                        masterInfos: machineMasterInfos,
                    },
                );
            }
        } else {
...
const condProcOnChange = async (count, prefix = '', parentFormId = '') => {
    ...
    const [lineIds, lineVals, lineMasterInfos] = getFilterByTypes(
        procInfo,
        filterTypes.LINE,
    );
    ...
    if (lineIds) {
        ...
        addGroupListCheckboxWithSearch(
            ...
            lineVals,
            {
                ...
                noFilter: true,
                thresholdBoxes,
                masterName: masterNameColumnDict.__LINE__,
                masterInfos: lineMasterInfos,
            },
        );
    ...
    const [partnoIds, partnoVals, partMasterInfos] = getFilterByTypes(
        procInfo,
        filterTypes.PART_NO,
    );
    ...
    if (partnoIds) {
        ...
        addGroupListCheckboxWithSearch(
            ...
            partnoVals,
            {
                ...
                noFilter: true,
                thresholdBoxes,
                masterName: masterNameColumnDict.__PART_NO__,
                masterInfos: partMasterInfos,
            },
        );
    }
...
const buildSummaryChartTitle = (
    ...
    const facets0 = facets[0] === '' ? COMMON_CONSTANT.NA : facets[0];
    const facetLevel1Text = hasFacet
        ? `<span class="${hasLevel12OnRightBox ? 'mr-2' : ''}">
        <span title="${facetName[0]}">${facetName[0]}</span>
        <span class="${showFitlerClass}"  title="${facets0}">${facets0}</span>
    </span>`
        : '';
    const facets1 = facets[1] === '' ? COMMON_CONSTANT.NA : facets[1];
    const facetLevel2Text = hasLevel2
        ? `<span>
        <span title="${facetName[1]}">${facetName[1]}</span>
        <span class="${showFitlerClass}" title="${facets1}">${facets1}</span>
    </span>`
        : '';
