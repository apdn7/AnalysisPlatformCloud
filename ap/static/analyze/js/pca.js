...
const drawPCAPlotJSON = (res, clickOnChart) => {
    ...
    const jsonPCABiplot = jsonParse(res.json_pca_biplot);
    const jsonT2TimeSeries = jsonParse(res.json_t2_time_series);
    const jsonQTimeSeries = jsonParse(res.json_q_time_series);
    const jsonPCAScoreTrain = jsonParse(res.json_pca_score_train);
    const jsonPCAScoreTest = jsonParse(res.json_pca_score_test);
    const jsonQContribution = jsonParse(res.json_q_contribution);
    const jsonT2Contribution = jsonParse(res.json_t2_contribution);
...
const loadSensors = () => {
    ...
    fetchWithLog('/ap/api/analyze/sensor', requestOptions)
