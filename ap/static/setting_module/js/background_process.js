...
const i18n = {
    ...
    TRANSACTION_IMPORT: $('#i18nTRANSACTION_IMPORT').text(),
    TRANSACTION_PAST_IMPORT: $('#i18nTRANSACTION_PAST_IMPORT').text(),
};
...
const updateFilterJobs = () => {
    ...
    throw new Error(
        "this is a bug, we don't have genGlobalID, consider fix this",
    );
};
...
function ajaxRequest(params) {
    ...
    const json = fetchWithLog(url + '?' + $.param(params.data), {
        method: 'GET',
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
