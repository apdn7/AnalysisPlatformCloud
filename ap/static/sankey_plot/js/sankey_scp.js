...
const drawScatterPlot = (canvasID, props, showLine = false) => {
    const data = [
        {
            x: props.x,
            y: props.y,
            objective_fmt: props.objective_fmt,
            mode: 'markers',
            type: 'scatter',
            marker: {
                color: COLOR.GREEN,
    ...
    const layout = {
        ...
        xaxis: {
            ...
            tickformat: _.isEmpty(props.objective_fmt)
